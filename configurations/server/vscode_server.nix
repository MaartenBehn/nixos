{ pkgs, ... }: {
  ...
  systemd.services.vscode = {
    ...
    ##script = "openvscode-server --connection-token voZ2d5c7o7lJ6l4C7FDqoaOcWVo2QGzvyf6 --host :: --port 44820";
    script = "openvscode-server --connection-token 1234 --host 0.0.0.0 --port 44820";
