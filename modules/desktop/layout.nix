{
  flake.modules.homeManager.hyprland = { pkgs, lib, config, ... }:
    let
        ...
        layouts = if config.host == "stroby-laptop" then {
          ...
          layouts = {
            ...
            home = {
              monitors = [
                "eDP-1,2256x1504,0x0,1"
                "DP-5,1920x1080, 1920x-1080,1"
                "DP-7,1920x1080, 1920x-1080,1"
                "DP-6,1920x1080, 0x-1080,1"
                "DP-8,1920x1080, 0x-1080,1"
              ];
