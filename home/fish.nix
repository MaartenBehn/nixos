{ ... }:
{
  programs.fish = {
    ...
    interactiveShellInit = ''
      ...
      alias dont_panic-vpn-start="sudo systemctl start wg-quick-dont_panic_over_ropelab.service"
      alias dont_panic-vpn-stop="sudo systemctl stop wg-quick-dont_panic_over_ropelab.service"
